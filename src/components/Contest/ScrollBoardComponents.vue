<template>
    <div
      class="flex flex-row"
      :class="{
        '-mb-1': route.name == 'ScrollRank',
        'gap-2': route.name != 'ScrollRank',
      }"
    >
      <div
        class="bg-white pl-6 pr-2 gap-2 flex items-center justify-between w-full border-b-0"
        :class="{
          'shadow-lg Border rounded-none': route.name != 'ScrollRank',
          '': route.name == 'ScrollRank',
        }"
      >
        ...
        <ul
          ...
          :class="{
            'rounded-2xl shadow-lg Border': route.name != 'ScrollRank',
            '': route.name == 'ScrollRank',
          }"
        >
          <li>
            <a @click="()=>{
             if (route.name == 'ScrollRank') {
                  $router.push({
                    name: 'ContestRanking',
                    params: {
    ...
    <div
      ...
      v-if="props.contest.CID && route.name == 'ScrollRank'"
    >
      <div
