<template>
  <div
    class="navbar border-b bg-white fixed top-0 z-[100] backdrop-blur-md bg-opacity-60"
  >
        ...
        <div class="dropdown dropdown-bottom dropdown-end">
          <div tabindex="0" role="button" class="btn">
            <img
              ...
              class="select-none avatar h-10 w-10 -ml-2 rounded-full"
              draggable="false"
            />
          ...
          <ul
            tabindex="0"
            class="dropdown-content z-[1] menu shadow bg-white rounded-box w-36 Border font-bold"
          >
            <li>
              <a
                @click="
            ...
            <li v-if="userDataStore.PermissionMap > 3">
              <a @click="$router.replace({ name: 'Admin' })">
                <setting-config theme="outline" size="18" />
                管理平台
              </a>
            </li>
            <!-- <li> -->
            <Confirm :action="props.logout">
              <template #default="{ showConfirmModal }">
                <li>
