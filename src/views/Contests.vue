      ...
      <Col>
        <table class="table table-zebra table-pin-rows">
          ...
          <tbody v-auto-animate>
            <tr
              v-for="item in contests.contests"
              :key="item.CID"
              @click="
                item.Status &&
                  $router.push({
              ...
              :class="{
                ...
                'cursor-not-allowed': !item.Status,
              }"
            >
              <td
                class="font-bold talbe-lg whitespace-nowrap hidden md:table-cell"
              ...
              <td
                class="space-y-0.5 [&_span]:badge [&_span]:mr-1 [&_span]:font-bold [&_span]:text-white"
              >
                <span
                  :style="
                    item.Type == 1
        ...
        <Pagination
          :page="contests.page"
          :maxPage="maxPage"
          :changePage="contests.changePage"
          class="pb-6"
        />
      </Col>
    </Card>
...
let contests = reactive<ContestsType>({
  ...
  get(showInfo = false) {
    ...
    _getContests(params).then((data: any) => {
