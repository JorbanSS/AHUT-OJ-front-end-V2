  ...
  <div class="grid grid-cols-12 gap-6 max-w-5xl mx-auto">
    <div class="space-y-6 col-span-4">
      ...
      <div class="card Border bg-white shadow-lg p-6 w-fit">
        ...
        <div class="m-1"></div>
        <button class="btn btn-neutral" @click="uploadBanner()">
          上传图片
        </button>
      </div>
      <!-- 班级小组管理 -->
      <div class="card Border bg-white shadow-lg p-6 w-full">
        <label class="form-control w-full max-w-xs">
          <div class="mb-2 w-full">
            <span class="">班级小组管理</span>
          </div>
        </label>
        <div class="m-1"></div>
    ...
    <div class="space-y-6 col-span-4">
      <div class="card Border bg-white shadow-lg p-6 w-full space-y-2">
        ...
        <button class="btn btn-neutral" @click="rejudgeInfo.rejudge()">
          重判
        </button>
      </div>
    </div>
      ...
      <div class="card Border bg-white shadow-lg p-6 w-full space-y-2">
        <div class="flex">
          ...
          <a class="ml-3 font-bold link link-hover"
            ...
            target="_blank">已接入 Google Analytics</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-box max-w-5xl">
        ...
        <div class="modal-action">
          <form method="dialog">
            ...
            <button class="btn btn-neutral" @click="homeNotice.edit()">
              提交修改
            </button>
          </form>
        </div>
...
let rejudgeInfo = reactive<RejudgeInfoType>({
  ...
  rejudge() {
    ...
    if (Timestamp.value != "")
      this.Timestamp = new Date(Timestamp.value).getTime();
